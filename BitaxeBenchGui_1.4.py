"""
Bitaxe All Model Hashrate Benchmark — GUI Edition  v1.4
...
class BitaxeBenchmark:
    ...
    def run(self):
        try:
            ...
            while cur_v <= max_v and cur_f <= max_f:
                if self.stop_event.is_set():
                    break
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Label(
            banner, text="⛏  BITAXE ALL CHIP BENCHMARK  v1.4",
            bg=C["accent"], fg="#111827",
